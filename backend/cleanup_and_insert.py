#!/usr/bin/env python3
"""
Script to clean up partial test templates and insert all correctly
"""
import asyncio
import asyncpg
import os
...
async def cleanup_and_insert():
    """Clean up partial inserts and insert all test templates"""
    try:
        ...
        print("Cleaning up existing test templates...")
        await conn.execute("DELETE FROM templates WHERE name LIKE 'Test:%'")
...
[
  {
    ...
    "explanation": "Clear explanation of the answer"
        ...
        print("Inserting all test templates...")
...
if __name__ == "__main__":
    success = asyncio.run(cleanup_and_insert())
    if success:
        print("\n✅ All English test templates are ready for testing the intelligent question type detection system!")
    else:
